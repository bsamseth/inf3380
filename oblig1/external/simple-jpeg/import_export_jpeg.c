 ...
 * read_write_jpeg.c
 *
 * This file is based on 'example.c' from the IJG open source library.
 * (See http://www.ijg.org/ for more info about IJG.)
 * The purpose is to implement two APIs, one for reading a jpeg image
 * from a file, the other for writing a jpeg image to a file.
 *
 */
